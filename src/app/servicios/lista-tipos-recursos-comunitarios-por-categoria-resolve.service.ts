...
export class ListaTiposRecursosComunitariosResolvePorCategoriaService implements Resolve<ITipoRecursoComunitario> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<ITipoRecursoComunitario> {
    ...
    return this.cargaTiposRecursosComunitarios.getTipoRecursoComunitarioClasificacion(route.params['id']).pipe(
      catchError(error => {
